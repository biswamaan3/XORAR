...
export default function CartItems() {
	return (
		<ul className='cart-product-container w-full mx-auto p-5 bg-white rounded-xl border border-gray-200'>
			{items.map((item) => (
				<li
					key={item.id}
					className='cart-item flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-4 pb-5 last:pb-0   border-b last:border-b-0'
				>
					...
					<div className='grid grid-flow-col gap-3 w-full h-auto'>
						<div className='item-details flex flex-col w-[100%]'>
							...
							<p className='dollar-sign mt-3'>${item.price}</p>
						</div>
