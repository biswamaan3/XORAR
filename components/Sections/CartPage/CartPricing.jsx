    ...
    <div className="cart-pricing-container flex flex-col gap-6 p-6 rounded-[20px] border border-[rgba(0,0,0,0.1)] mx-auto w-full">
      ...
      <div className="summary-details flex flex-col gap-5 w-full">
        <div className="flex justify-between items-center w-full">
          <span className="text-lg text-[rgba(0,0,0,0.6)]">Subtotal</span>
          <span className="text-lg font-bold text-black">$565</span>
        </div>
        <div className="flex justify-between items-center w-full">
          <span className="text-lg text-[rgba(0,0,0,0.6)]">Discount (-20%)</span>
          <span className="text-lg font-bold text-red-500">-$113</span>
        </div>
        <div className="flex justify-between items-center w-full">
          <span className="text-lg text-[rgba(0,0,0,0.6)]">Delivery Fee</span>
      ...
      <div className="promo-code flex flex-row gap-3 sm:gap-5 items-center w-full">
        <div className="promo-input flex items-center gap-3 bg-gray-100 rounded-full w-full px-4 py-3">
          <img src="/assets/svg/Promo_Icon.svg" alt="Promo code" className="w-5 h-5 ml-2" />
          <input
            type="text"
      ...
      >
        Go to Checkout
        <img src="/assets/svg/Right_arrow.svg" alt="Promo code" className="w-4 h-4" />
      </button>
    </div>
  );
}
