  ...
  return (
    <div className="mt-8">
      ...
      <div className="text-center">
        <p className="font-satoshi text-2xl font-medium text-black">Rating & Reviews</p>
      ...
      <div className="flex flex-wrap justify-between items-center mt-5">
        {/* Reviews Title */}
        <div>
          <span className="font-satoshi text-2xl font-bold text-black">All Reviews</span>
          <span className="font-satoshi text-sm text-gray-500 ml-2">(451)</span>
        </div>
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="p-4 rounded-full bg-gray-200">
            <Image src="/assets/svg/reviews-filter.svg" width={19} height={19} alt="reviews-filter" />
          </div>

          {/* Latest Button */}
          <div className="flex items-center gap-2 px-5 py-3 rounded-full bg-gray-200">
            <p className="font-satoshi text-sm text-gray-600">Latest</p>
            <IoChevronDown />
          </div>

          {/* Add Review Button */}
          <div className="flex items-center gap-2 px-5 py-3 rounded-full bg-[#012F3F]">
            <p className="font-satoshi text-sm text-white">Add a Review</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-5 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
        {testimonials.map((testimonial, index) => (
          <TestimonialCard key={index} ratings={testimonial.stars} {...testimonial} className="w-full" withDate withMenu />
        ))}
      </div>
